...
PLATFORM_INFRASTRUCTURE_DATA = {
    'ASMP': {
        ...
        'header_img': "images/platforms/ASMP/infrastructure_ASMP/Infra-bg.jpg",
        'gallery_texts': {
            'section_1': {
                'title': "Powder-Based",
        ...
        'slider_images': [
            "images/platforms/ASMP/infrastructure_ASMP/flexslider/AMLAB1.jpg",
            "images/platforms/ASMP/infrastructure_ASMP/flexslider/AMLAB2.jpg",
            "images/platforms/ASMP/infrastructure_ASMP/flexslider/AMLAB3.jpg",
            "images/platforms/ASMP/infrastructure_ASMP/flexslider/AMLAB4.jpg",
            "images/platforms/ASMP/infrastructure_ASMP/flexslider/AMLAB5.jpg",
        ]
    },
    'BIO': {
        ...
        'header_img': "images/platforms/BIO/infrastructure_BIO/Infra-bg.jpg",
        'gallery_texts': {
            'section_1': {
                'title': "Biotechnology ",
                'subtitle': "Laboratory",
        ...
        'slider_images': [
            "images/platforms/BIO/infrastructure_BIO/Lab01.jpg",
            "images/platforms/BIO/infrastructure_BIO/Lab02.jpg",
            "images/platforms/BIO/infrastructure_BIO/Lab03.jpg",
            "images/platforms/BIO/infrastructure_BIO/Lab04.jpg",
        ]
    },
    'MSC': {
        ...
        'header_img': "images/platforms/MSC/infrastructure_MSC/MSC_header.png",
        'gallery_texts': {
            'section_1': {
        ...
        'slider_images': [
            "images/platforms/MSC/infrastructure_MSC/lab01.webp",
            "images/platforms/MSC/infrastructure_MSC/lab02.webp",
            "images/platforms/MSC/infrastructure_MSC/lab03.webp",
        ]
    },
    'PCE': {
        ...
        'header_img': "images/platforms/PCE/infrastructure_PCE/PCE_header.jpg",
        'gallery_texts': {
            'section_1': {
        ...
        'slider_images': [
            "images/platforms/PCE/infrastructure_PCE/lab01.jpg",
            "images/platforms/PCE/infrastructure_PCE/lab02.jpg",
            "images/platforms/PCE/infrastructure_PCE/lab03.jpg",
            "images/platforms/PCE/infrastructure_PCE/lab04.jpg",
        ]
    },
    'RESEE': {
        ...
        'header_img': "images/platforms/RESEE/infrastructure_RESEE/RESEE_header.webp",
        'gallery_texts': {
            'section_1': {
                'title': "Heat transfer",
                'subtitle': "Laboratory",
        ...
        'slider_images': [
            "images/platforms/RESEE/infrastructure_RESEE/lab01.webp",
            "images/platforms/RESEE/infrastructure_RESEE/lab02.webp",
            "images/platforms/RESEE/infrastructure_RESEE/lab03.webp",
            "images/platforms/RESEE/infrastructure_RESEE/lab04.webp",
        ]
    },
    'SAI': {
        ...
        'header_img': "images/platforms/sai/infrastructure_sai/SAI-header",
        'gallery_texts': {
            'section_1': {
                'title': "Automatism",
                'subtitle': "Laboratory",
        ...
        'slider_images': [
            "images/platforms/sai/infrastructure_sai/lab01.jpg",
            "images/platforms/sai/infrastructure_sai/lab02.jpg",
            "images/platforms/sai/infrastructure_sai/lab03.jpg",
        ]
    },
    'AIDE': {
        ...
        'header_img': "images/platforms/AIDE/infrastructure_AIDE/img.jpg",
        'gallery_texts': {
            'section_1': {
        ...
        'slider_images': [
            "images/platforms/AIDE/infrastructure_AIDE/lab02.jpg",
            "images/platforms/AIDE/infrastructure_AIDE/lab03.jpg",
            "images/platforms/AIDE/infrastructure_AIDE/lab01.jpg",
        ]
    }
}

def _get_base_infrastructure_context(platform_code):
    """Generate base context for infrastructure views using configuration"""
    platform_data = PLATFORM_INFRASTRUCTURE_DATA[platform_code]
    
    # Generate slider image URLs
    slider_urls = {}
    for i, image_path in enumerate(platform_data['slider_images'], 1):
        slider_urls[f'slider_image_url_{i}'] = static(image_path)
    
    return {
        'categories': Category.objects.all(),
        'products': Machine.objects.all(),
        'image_header': platform_data['image_header'],
        'image_descriptions': platform_data['image_descriptions'],
        'header_img': static(platform_data['header_img']),
        'gallery_texts': platform_data['gallery_texts'],
        'platform_name': platform_data['platform_name'],
        **slider_urls,
        'logo': static('images/logo-black.png'),
        'services_url': reverse(f'{platform_code}_services'),
        'index_url': reverse(f'{platform_code}_index'),
        'infrastructure_url': reverse(f'{platform_code}_infrastructure'),
        'innovation_url': reverse(f'{platform_code}_innovation'),
    }

# Platforms infrastructures
def ASMP_infrastructure(request):
    """Render infrastructure page for ASMP platform using configuration"""
    context = _get_base_infrastructure_context('ASMP')
    return render(request, 'platforms/ASMP/infrastructure.html', context)

def BIO_infrastructure(request):
    """Render infrastructure page for BIO platform using configuration"""
    context = _get_base_infrastructure_context('BIO')
    return render(request, 'platforms/BIO/infrastructure.html', context)
def MSC_infrastructure(request):
    """Render infrastructure page for MSC platform using configuration"""
    context = _get_base_infrastructure_context('MSC')
    return render(request, 'platforms/MSC/infrastructure.html', context)

def PCE_infrastructure(request):
    """Render infrastructure page for PCE platform using configuration"""
    context = _get_base_infrastructure_context('PCE')
    return render(request, 'platforms/PCE/infrastructure.html', context)

def RESEE_infrastructure(request):
    """Render infrastructure page for RESEE platform using configuration"""
    context = _get_base_infrastructure_context('RESEE')
    return render(request, 'platforms/RESEE/infrastructure.html', context)
def SAI_infrastructure(request):
    """Render infrastructure page for SAI platform using configuration"""
    context = _get_base_infrastructure_context('SAI')
    return render(request, 'platforms/SAI/infrastructure.html', context)

def AIDE_infrastructure(request):
    """Render infrastructure page for AIDE platform using configuration"""
    context = _get_base_infrastructure_context('AIDE')
    ...
    context = {
        ...
        'sections': {
            ...
            'section4': {
                ...
                'img': static('images/platforms/MSC/innovation_MSC/inno4.png')
    ...
    context = {
       'logo': static('images/logo-black.png'),
        ...
        'section_1': {
            ...
            'img': static('images/platforms/ASMP/services_ASMP/srv1.jpg')
        ...
        'section_2': {
            ...
            'img': static('images/platforms/ASMP/services_ASMP/srv2.jpg')
        ...
        'section_5': {
            ...
            'img': static('images/platforms/ASMP/services_ASMP/srv5.jpg')
    ...
    context = {
       'logo': static('images/logo-black.png'),
        ...
        'section_1': {
            ...
            'img': static('images/platforms/AIDE/services_AIDE/srv1.jpg')
        ...
        'section_3': {
            ...
            'img': static('images/platforms/AIDE/services_AIDE/srv3.jpg')
    ...
    context = {
       'logo': static('images/logo-black.png'),
        ...
        'section_7': {
            ...
            'img': static('images/platforms/RESEE/services_RESEE/srv7.jpg')
...
def sitemap(request):
    ...
    # List of all important URLs with their metadata
    urls = [
        {
            'loc': 'https://labs.ueuromed.org/',
            'lastmod': '2025-09-01',
            'changefreq': 'daily',
            'priority': '1.0'
        },
        {
            'loc': 'https://labs.ueuromed.org' + reverse('ASMP_index'),
            'lastmod': '2025-09-01',
            'changefreq': 'weekly',
            'priority': '0.9'
        },
        {
            'loc': 'https://labs.ueuromed.org' + reverse('BIO_index'),
            'lastmod': '2025-09-01',
            'changefreq': 'weekly',
            'priority': '0.9'
        },
        {
            'loc': 'https://labs.ueuromed.org' + reverse('MSC_index'),
            'lastmod': '2025-09-01',
            'changefreq': 'weekly',
            'priority': '0.9'
        },
        {
            'loc': 'https://labs.ueuromed.org' + reverse('PCE_index'),
            'lastmod': '2025-09-01',
            'changefreq': 'weekly',
            'priority': '0.9'
        },
        {
            'loc': 'https://labs.ueuromed.org' + reverse('RESEE_index'),
            'lastmod': '2025-09-01',
            'changefreq': 'weekly',
            'priority': '0.9'
        },
        {
            'loc': 'https://labs.ueuromed.org' + reverse('SAI_index'),
            'lastmod': '2025-09-01',
            'changefreq': 'weekly',
            'priority': '0.9'
        },
        {
            'loc': 'https://labs.ueuromed.org' + reverse('AIDE_index'),
            'lastmod': '2025-09-01',
            'changefreq': 'weekly',
            'priority': '0.9'
        },
        {
            'loc': 'https://labs.ueuromed.org' + reverse('contact'),
            'lastmod': '2025-09-01',
            'changefreq': 'monthly',
            'priority': '0.5'
        }
